...
def start():
    ...
    print('----------------------------------------------------------------------------------------')
    print('')
    print('Welcome!!! GacO 2.0V is a programme which can use to find Gaussian out file results,')
    print('')
    ...
    print('')
    print("Whats new in GacO 2.0V,")
    print('')
    print('     ==> Automated calculations feature will select only the "xyz.out" files in the path.')
...
def help():
    ...
    print('                                            ++++++++++++++++')
    print('')
    print('+ GacO 2.0V is a programme that is mainly focusing on finding the optimized energy values,')
    ...
    print('+ GacO 2.0V creates graphs of Gamma Values VS Wave Length.')
    print('+ Python 3.7 is the base code of the GacO 2.0V programme.')
    print('+ GacO 2.0V consist of 1355 Python code lines.')
    print('')
    print('How to enter a Gaussian output file ? ')
    print('  + Gaussian output file and the GacO 2.0V programme must be in the same directory.')
    ...
    print('  + Create a folder and place the "GacO_2.0V.exe".')
...
def GacOMenu():
    ...
    if inP == 1:
        ...
        automatedCalculation('GacO_2.0V.exe')
        errorHandler(GacOMenu)
    elif inP == 4:
        help()
        errorHandler(GacOMenu)
