...
def start():
    ...
    print('----------------------------------------------------------------------------------------')
    print('')
    print('Welcome!!! GacO 1.8V is a programme which can use to find Gaussian out file results,')
    print('')
    ...
    print('')
    print("Whats new in GacO 1.8V,")
    print('')
    print('     ==> Create graphs for every trial.')
...
def help():
    ...
    print('                                            ++++++++++++++++')
    print('')
    print('+ GacO 1.8V is a programme that is mainly focusing on finding the optimized energy values,')
    ...
    print('+ GacO 1.8V creates graphs of Gamma Values VS Wave Length.')
    print('+ Python 3.7 is the base code of the GacO 1.8V programme.')
    print('+ GacO 1.8V consist of 1340 Python code lines.')
    print('')
    print('How to enter a Gaussian output file ? ')
    print('  + Gaussian output file and the GacO 1.8V programme must be in the same directory.')
    ...
    print('  + Create a folder and place the "GacO_1.8V.exe".')
...
def GacOMenu():
    ...
    if inP == 1:
        ...
        automatedCalculation('GacO_1.8V.exe')
        errorHandler(GacOMenu)
    elif inP == 4:
        help()
        errorHandler(GacOMenu)
