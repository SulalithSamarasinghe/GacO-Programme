#GacO_1.2V is a programme which can use to find the optimized energy values and
...
print('********************')
print('')
print('Welcome!!! GacO 1.2V is a programme which can use to find Gaussian out file results,')
print('')
...
def GacOMenu():
    ...
    #
        ...
        print('++++++++++++++++')
        print('')
        print('+ GacO 1.2V is a programme that is mainly focusing on finding the optimized energy values,')
        print('  parallel and perpendicular gamma values of a Gaussian output file.')
        print('+ Python 3.7 is the base code of the GacO 1.2V programme.')
        print('+ GacO 1.2V consist of 499 Python code lines.')
        print('')
        print('How to enter a Gaussian output file ? ')
        print('  + Gaussian output file and the GacO 1.2V programme must be in the same directory.')
