...
def start():
    ...
    print('----------------------------------------------------------------------------------------')
    print('')
    print('Welcome!!! GacO 1.9V is a programme which can use to find Gaussian out file results,')
    print('')
    ...
    print('')
    print("Whats new in GacO 1.9V,")
    print('')
    print('     ==> Percentage error for three trials.')
...
def help():
    ...
    print('                                            ++++++++++++++++')
    print('')
    print('+ GacO 1.9V is a programme that is mainly focusing on finding the optimized energy values,')
    ...
    print('+ GacO 1.9V creates graphs of Gamma Values VS Wave Length.')
    print('+ Python 3.7 is the base code of the GacO 1.9V programme.')
    print('+ GacO 1.9V consist of 1343 Python code lines.')
    print('')
    print('How to enter a Gaussian output file ? ')
    print('  + Gaussian output file and the GacO 1.9V programme must be in the same directory.')
    ...
    print('  + Create a folder and place the "GacO_1.9V.exe".')
...
def GacOMenu():
    ...
    if inP == 1:
        ...
        automatedCalculation('GacO_1.9V.exe')
        errorHandler(GacOMenu)
    elif inP == 4:
        help()
        errorHandler(GacOMenu)
