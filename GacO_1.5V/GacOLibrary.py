...
def start():
    ...
    print('----------------------------------------------------------------------------------------')
    print('')
    print('Welcome!!! GacO 1.5V is a programme which can use to find Gaussian out file results,')
    print('')
    ...
    print('')
    print("Whats new in GacO 1.5V,")
    print('')
    print('     ==> New format for the xyz.csv files.')
...
def help():
    ...
    print('                                            ++++++++++++++++')
    print('')
    print('+ GacO 1.5V is a programme that is mainly focusing on finding the optimized energy values,')
    ...
    print('+ GacO 1.5V creates graphs of Gamma Values VS Wave Length.')
    print('+ Python 3.7 is the base code of the GacO 1.5V programme.')
    print('+ GacO 1.5V consist of 772 Python code lines.')
    print('')
    print('How to enter a Gaussian output file ? ')
    print('  + Gaussian output file and the GacO 1.5V programme must be in the same directory.')
